...
class ReactThreejs_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('ReactThreejs', 'ReactThreejs', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="ReactThreejs"></div>';
  }
...
$ReactThreejs_options = new ReactThreejs_options();
$ReactThreejs_options->init();